    ...
    <section className={`min-h-screen flex items-center justify-center relative overflow-hidden ${
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="animate-fade-in-up">
          ...
          <p className={`text-lg sm:text-xl leading-relaxed mb-12 max-w-3xl mx-auto ${
            darkMode ? 'text-gray-400' : 'text-gray-700'
          }`}>
            Passionate about Data Structures (Java), Python scripting, and frontend development. 
            I enjoy solving problems, building real-world projects, and contributing to collaborative environments.
          </p>
